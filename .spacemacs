...
(defun create-js-layout()
  (interactive)
  (insert "const Layout = ({}) => {\n")
  (insert "\treturn (\n\t<>\n\t</>\n\t);\n")
  (insert "};\n")
  (insert "export default Layout;")
  )
(defun create-js-component-skeleton()
  (interactive)
  (insert "import Layout from \'./Layout\';\n")
  (insert "const Component = ({}) => {\n\treturn <Layout/>;\n };\n")
...
(global-set-key (kbd "C-c C-i") 'create-js-component-skeleton)
(global-set-key (kbd "C-c C-y") 'create-js-layout)
(global-set-key (kbd "C-c C-l") 'insert-consolelog)
